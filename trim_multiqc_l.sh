...
#SBATCH --job-name="trim_multiqc_l"
#SBATCH --output=trim_multiqc_l.out
...
cd /data4/msc23104469/caf-lung/outdir_lung/trimmed_reads/multiqc_trimmed_reads/
...
# Define directories
TRIMMED_READS_DIR="/data4/msc23104469/caf-lung/outdir_lung/trimmed_reads/multiqc_trimmed_reads"
